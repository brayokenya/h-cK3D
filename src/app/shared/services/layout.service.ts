...
export class LayoutService {
    ...
    setAppLayout() {
        ...
        this.layoutConf = {
            ...
            sidebarColor: 'yellow',      // http://demos.ui-lib.com/egret-doc/#egret-colors
            sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
            dir: 'ltr',                 // ltr, rtl
            useBreadcrumb: true,
            topbarFixed: true,
            topbarColor: 'yellow',       // http://demos.ui-lib.com/egret-doc/#egret-colors
            matTheme: 'app-mookh',     // app-blue, app-navy, app-dark-purple, app-dark-pink, app-mookh
